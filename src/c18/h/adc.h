...
#define ADC_INT_DISABLE()    (PIE1bits.ADIE=0)
	...
	defined (ADC_V10) || defined (ADC_V11) || defined (ADC_V11_1) || defined (ADC_V12) || defined (ADC_V13) || defined (ADC_V13_1)
...
#elif defined (ADC_V11) || defined (ADC_V8) || defined (ADC_V11_1) 
...
#define ADC_CH_MASK		 (~ADC_CH31)			//Mask ADC channel selection bits
...
#define ADC_NEG_CH_MASK		 (~ADC_NEG_CH7)			//Mask ADC Negetive channel selection bits
#endif //USE_OR_MASKS
...
void OpenADC ( unsigned char ,
      ...
      defined (ADC_V7) || defined (ADC_V7_1)|| defined (ADC_V12) || defined (ADC_V13) || defined (ADC_V13_1)
...
void OpenADC ( unsigned char ,
	...
	defined (ADC_V13_1) || defined ( ADC_V11_1)
